...
import $package$.child.{ChildService, ChildServiceArgs, ServerConfig as ChildServerConfig}
import $package$.parent.{ParentService, ParentServiceArgs, ServerConfig as ParentServerConfig}
...
@main def main = Pulumi.run:
  ...
  val childApp = ChildService(
    ...
    ChildServiceArgs(
      ...
      runConfig = ChildServerConfig(greeting = "Hello")
    )
  )
